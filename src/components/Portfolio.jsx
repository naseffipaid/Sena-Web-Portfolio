  ...
  const projectsData = [
    {
      ...
      projectInfo:
        "A platform designed to bring people together to discuss and share ideas. It features user authentication, discussion forums, and a responsive design.",
      client: "Personal Project",
      technologies: "React, Node.js, Mysql, CSS3 ,jason web token",
